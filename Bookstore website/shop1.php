...
<body>
 ...
 <div class="page-shop-sidebar left--sidebar bg--white section-padding--md">
        	<div class="container">
        		<div class="row">
        			<div class="col-lg-3 col-12 order-2 order-lg-1 md-mt-40 sm-mt-40">
        				<div class="shop__sidebar">
        					...
        					<aside class="wedget__categories sidebar--banner">
								<img src="img/sherlock.jpg" alt="banner images">
								<div class="text">
									<h2>new products</h2>
                                    ...
                                    <div class="col-lg-4 col-md-4 col-sm-6 col-12">
                                        <div class="product">
                                            <div class="product__thumb">
                                                <a class="first__img" href="product1.php?id=<?php echo $list['book_id']?>"><img src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']?>" alt="product image"></a>
                                                <div class="new__box">
                                            ...
                                            <div class="product__content">
                                                <h4><a href="single-product.html"><?php echo $list['title']?></a></h4>
